...
from . import agents, flat_env_cfg, rough_env_cfg, flat_env_imu_cfg
...
gym.register(
    id="Template-Isaac-Velocity-Flat-Imu-MiniCheetah-v1",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_imu_cfg:MiniCheetahFlatEnvImuCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:MiniCheetahFlatPPORunnerCfg",
    },
)

gym.register(
    id="Template-Isaac-Velocity-Flat-Imu-MiniCheetah-Play-v1",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_imu_cfg:MiniCheetahFlatEnvImuCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:MiniCheetahFlatPPORunnerCfg",
    },
)