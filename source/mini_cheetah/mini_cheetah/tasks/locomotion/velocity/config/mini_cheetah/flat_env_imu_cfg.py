...
import mini_cheetah.tasks.locomotion.velocity.config.mini_cheetah.mdp as mini_cheetah_mdp
import mini_cheetah.tasks.locomotion.velocity.mdp as mdp_v0
##
# Pre-defined configs
##
# from omni.isaac.lab_assets.DOG import DOG_CFG  # isort: skip
# from omni.isaac.lab_assets.Dog import DOG_CFG
from mini_cheetah.assets.mini_cheetah import MINI_CHEETAH_CFG
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        imu_orientation = ObsTerm(
            func=mdp_v0.imu_projected_gravity,
            noise=Unoise(n_min=-5e-2, n_max=5e-2),
        )
...
class EventCfg:
    ...
    reset_robot_joints = EventTerm(
        func=mini_cheetah_mdp.reset_joints_around_default,
        mode="reset",
        params={
...
class RewardsCfg:
    ...
    base_linear_velocity = RewardTermCfg(
        func=mini_cheetah_mdp.base_linear_velocity_reward,
        weight=5.0,
        params={"std": 1.0, "ramp_rate": 0.5, "ramp_at_vel": 1.0, "asset_cfg": SceneEntityCfg("robot")},
    )
    foot_clearance = RewardTermCfg(
        func=mini_cheetah_mdp.foot_clearance_reward,
        weight=0.5,
        params={
            "std": 0.05,
            "tanh_mult": 2.0,
    ...
    gait = RewardTermCfg(
        func=mini_cheetah_mdp.GaitReward,
        weight=10.0,
        params={
            "std": 0.1,
            "max_err": 0.2,
            "velocity_threshold": 0.5,
            "synced_feet_pair_names": (("FL_calf", "RR_calf"), ("FR_calf", "RL_calf")),
            "asset_cfg": SceneEntityCfg("robot"),
    ...
    base_orientation = RewardTermCfg(
        func=mini_cheetah_mdp.base_orientation_penalty, weight=-3.0, params={"asset_cfg": SceneEntityCfg("robot")}
    )
    foot_slip = RewardTermCfg(
        func=mini_cheetah_mdp.foot_slip_penalty,
        weight=-0.5,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_calf"),
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_calf"),
...
@configclass
class MiniCheetahFlatEnvImuCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.imu = ImuCfg(prim_path="{ENV_REGEX_NS}/Robot/base", debug_vis=True)


class MiniCheetahFlatEnvImuCfg_PLAY(MiniCheetahFlatEnvImuCfg):
