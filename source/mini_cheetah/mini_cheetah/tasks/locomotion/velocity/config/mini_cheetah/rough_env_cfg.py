...
from mini_cheetah.tasks.locomotion.velocity.mini_cheetah_velocity_env_imu_cfg import MiniCheetahLocomotionVelocityRoughEnvImuCfg
...
@configclass
class MiniCheetahRoughEnvImuCfg(MiniCheetahLocomotionVelocityRoughEnvImuCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # switch robot to mini cheetah
...
@configclass
class MiniCheetahRoughEnvImuCfg_PLAY(MiniCheetahRoughEnvImuCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
