...
class RewardsCfg:
    ...
    base_height_l2 = RewTerm(
        ...
        weight=-2.0,
        params={"asset_cfg": SceneEntityCfg("robot", body_names=["base"]), "target_height": 0.5}, # "target": 0.35         target not a param of base_pos_z
    )
    # -- optional penalties
...
@configclass
class MiniCheetahLocomotionVelocityRoughEnvImuCfg(ManagerBasedRLEnvCfg):
